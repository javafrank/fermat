...
public class GeolocationAdapter extends ArrayAdapter {
    ...
    public GeolocationAdapter(Context context, List<ExtendedCity> dataSet, ErrorManager errorManager,
        ...
        super(context, R.layout.dap_issuer_community_v2_geolocation_item, dataSet);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View item = inflater.inflate(R.layout.dap_issuer_community_v2_geolocation_item, null, true);
        try {
            ...
            errorManager.reportUnexpectedSubAppException(SubApps.DAP_ASSETS_COMMUNITY_ISSUER, UnexpectedSubAppExceptionSeverity.DISABLES_SOME_FUNCTIONALITY_WITHIN_THIS_FRAGMENT, e);
        }
        return item;
    }
}
